...
const ContactForm = (props) => {
  ...
  function renderFields() {
    const array = t("contact.formFields", { returnObjects: true });
    console.log(array);
...
function validate(values, props) {
  ...
  // if (errors.email) {
  //   errors.email = (
  //     <Trans>{props.t("contact.error.email", { email: values.email })}</Trans>
  //   );
  // }
  // if (array !== "contact.formFields") {
  ...
  //     if (!values[name]) {
  //       errors[name] = (
  //         <Trans>{props.t("contact.error.required", { name: label })}</Trans>
  //       );
  //     }
  //   });
  // }
